...
[ACTIONS] = LAYOUT(
KC_F13, ___, KC_MS_UP, ___, ___, ___,
___, ___, ___, ___, ___, KC_F17,

KC_F12, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, ___, ___,
___, KC_MS_LEFT, KC_MS_DOWN, KC_MS_UP, KC_MS_RIGHT, KC_F16,

KC_F11, ___, ___, ___, ___, ___, RGB_MOD, RGB_HUI,
RGB_VAI, RGB_TOG, ___, ___, ___, ___, ___, KC_F15,
...
[GAMING] = LAYOUT(
KC_TAB, ___, KC_W, ___, ___, ___,                       ___, ___, ___, ___, ___, ___,
KC_LCTL, KC_A, KC_S, KC_D, ___, ___,                       ___, KC_H, KC_J, KC_K, KC_L, ___,
